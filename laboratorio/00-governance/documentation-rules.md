...
Este documento define las reglas generales para crear, nombrar, enlazar y mantener documentos. Para ramas y commits, ver [git-conventions.md](./git-conventions.md). Para seguridad, ver [security-rules.md](./security-rules.md). Para estándares de código, ver [coding-standards.md](./coding-standards.md) (cuando esté disponible).
...
Documento nuevo
Verificar que no exista en otra sección.

Crear el archivo en la sección correcta.

Usar la estructura mínima.

Enlazarlo desde el README.md de la sección.
